    ...
    def _build_prompt(self, query: str, docs: List[str], history: deque) -> List[Dict]:
        ...
        if docs:
            ...
            system = (
                ...
                "- 'Can you give me a grammar lesson' / 'Can you teach me a grammar lesson'\n"
                "- 'Can you quiz me?' / 'Test my knowledge' / 'Quiz me on grammar'\n"
                "- 'I want to practice' / 'Let me practice' / 'Practice session'\n"
                "- ANY phrase with 'start' + 'lesson' (regardless of punctuation or extra words)\n"
                "- ANY phrase with 'begin' + 'lesson' or 'quiz' + 'grammar/vocab'\n"
                ...
                "For ambiguous requests about learning grammar/vocabulary:\n"
                "- Offer choice: 'Would you like me to explain grammar concepts, or start an interactive grammar lesson?'\n\n"
